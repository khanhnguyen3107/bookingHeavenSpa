...
$sql = "SELECT COUNT(*) AS total_rows FROM datlich 
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <form method="post" id="search">
                            ...
                            <input size="35px" placeholder="Nhập tên khách hoặc dịch vụ cần tìm..." type="text" name="search" value="<?php if (isset($_POST["search"])) {
                                                                                                                                            echo $_POST["search"];
                                                                                                                                        } ?>">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    WHERE khachhang.TenKH LIKE '%$search%' OR dichvu.TenDV LIKE '%$search%'
                                    ORDER BY datlich.NgayDat DESC
