...
$sql = "SELECT COUNT(*) AS total_rows 
        ...
        WHERE (MaKH IN (SELECT MaKH FROM khachhang WHERE TenKH LIKE '%$search%') 
            ...
            AND datlich.TrangThai = 'Đã đến' or datlich.TrangThai = 'Phản hồi'";
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Lịch Đã Hoàn Thành Của Heaven Spa</h5>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT datlich.MaDL, datlich.MaDV, datlich.MaKH, datlich.ThoiGianDat, datlich.NgayDat, datlich.TrangThai, datlich.ThoiLuong
                                        ...
                                        WHERE (khachhang.TenKH LIKE '%$search%' OR dichvu.TenDV LIKE '%$search%') AND datlich.TrangThai = 'Đã đến' OR datlich.TrangThai = 'Phản hồi'
