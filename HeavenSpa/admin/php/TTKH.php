...
$sql = "SELECT COUNT(*) AS total_rows FROM khachhang WHERE TenKH LIKE '%$search%'";
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Bảng Thông Tin Khách Hàng</h5>
                        </div>
                        <form method="post" id="search">

                            <input size="25px" placeholder="Nhập tên khách hàng cần tìm..." type="text" name="search" value="<?php if (isset($_POST["search"])) {
                                                                                                                                    echo $_POST["search"];
                                                                                                                                } ?>">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT *
                                    FROM khachhang
                                    WHERE TenKH LIKE '%$search%'  OR HoKH LIKE '%$search%' LIMIT $offset, $num_entries";
                                    $result = $conn->query($sql);
