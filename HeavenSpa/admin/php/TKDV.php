...
// Lấy dữ liệu số lần đặt cho tất cả các dịch vụ trong ngày được chọn
$sql = "SELECT dichvu.NhomDV, dichvu.TenDV, COUNT(datlich.MaDV) AS SoLanDat, nhomdichvu.TenNhom
        FROM dichvu
        LEFT JOIN datlich ON dichvu.MaDV = datlich.MaDV AND datlich.NgayDat = '$selectedDate'
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <form method="post" action="" class="date-selection-form form-inline">
                <div class="form-group">
                    <input type="date" id="selectedDate" name="selectedDate" class="form-control" value="<?php echo isset($_POST['selectedDate']) ? $_POST['selectedDate'] : $selectedDate; ?>">
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Số lần đặt các dịch vụ trong nhóm <?php echo $nhomDV; ?> ngày <?php echo $selectedDate ?></h5>
                            </div>
