...
$sql = "SELECT COUNT(*) AS total_rows 
        ...
        WHERE (khachhang.TenKH LIKE '%$search%' OR dichvu.TenDV LIKE '%$search%') AND datlich.TrangThai = 'Đã đặt'";
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Danh Sách Lịch Đang Chờ Duyệt Của Heaven Spa</h5>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td><input type='submit' name='Duyet' value='Duyệt'></td>";
                                            echo "</form>";
                                            echo "<form method='post'>";
                                            echo "<input type='hidden' name='madl' value='{$row["MaDL"]}'>";
