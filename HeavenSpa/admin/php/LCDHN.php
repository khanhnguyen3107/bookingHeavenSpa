...
if (isset($_POST["Duyet"])) {
    ...
    if ($update_result) {
        echo "<script>alert('Đã duyệt lịch')</script>";
        exit();
    } else {
        echo "<script>alert('Lỗi duyệt trạng thái'); window.location.href='LCDHN.php';</script>";
        exit();
    }
}
if (isset($_POST["Huy"])) {
    ...
    $update_result = $conn->query($update_sql);
    if ($update_result) {
        echo "<script>alert('Đã hủy lịch')</script>";
        exit();
    } else {
        echo "<script>alert('Lỗi duyệt trạng thái'); window.location.href='LCDHN.php';</script>";
        exit();
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Danh Sách Lịch Chờ Duyệt Hôm Nay (Ngày <?php echo $homnay; ?> )</h5>
                        </div>
