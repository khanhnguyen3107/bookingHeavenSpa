...
$sql = "SELECT COUNT(*) AS total_rows FROM phanhoi ";
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <form method="post" id="search">
                            ...
                            <input size="25px" placeholder="Nhập mã phản hồi cần tìm..." type="text" name="search" value="<?php if (isset($_POST["search"])) {
                                                                                                                            echo $_POST["search"];
                                                                                                                        } ?>">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT *
                                    FROM phanhoi
                                    WHERE MaDL LIKE '%$search%'  OR ChiTietPH LIKE '%$search%' LIMIT $offset, $num_entries";
                                    $result = $conn->query($sql);
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . substr($row["ChiTietPH"], 0, 3) . "..." . "<a href='' onclick='return confirm(\"" . $row["ChiTietPH"] . "\")'>Chi Tiết</a></td>";
                                            $stt++;
                                    }
                                }
